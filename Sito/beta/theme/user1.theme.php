<?php
	function already($g){
		$id = $_COOKIE['sid_id'];
		$return = mysql_query("SELECT * FROM Iscritti$g WHERE user = '$id'");
		?><script  type="text/javascript"><?php
		while($row = mysql_fetch_array($return)){
			?>
			document.getElementById("<?php echo $g; ?>.<?php echo $row['id_forum']; ?>").checked = true;
			<?php
			switch ($g){
				case "1":
					$ga3 = "a";
			...
			case "0":
				?>
					document.getElementById("<?php echo $ga3; ?>.0").checked = true;
				<?php
			break;
			case "1":
				?>
					document.getElementById("<?php echo $ga3; ?>.1").checked = true;
				<?php
			break;
			case "2":
				?>
	...
	function home($g){
		$id = $_COOKIE['sid_id'];
		$forum = array();
		$return = mysql_query("SELECT * FROM Giorno$g");
		while ($row = mysql_fetch_array($return)){
			$forum[$row['id']] = $row;
		}
		...
		while($row = mysql_fetch_array($return)){
			switch ($row['turno']){
				...
				?>
					<form>
						Un solo turno: <b><?php echo base64_decode($forum[$row['id_forum']]['name']); ?></b><br />
					</form>
				<?php
				break;
				case "1":
				?>
					<form>
						Primo turno: <b><?php echo base64_decode($forum[$row['id_forum']]['name']); ?></b><br />
					</form>
				<?php
				break;
				case "2":
				?>
					<form>
						Secondo turno: <b><?php echo base64_decode($forum[$row['id_forum']]['name']); ?></b><br />
					</form>
				<?php
				break;
			}
...
<a href="http://www.histats.com" alt="contatore" target="_blank" ><div id="histatsC"><img border="0" src="http://s4is.histats.com/stats/i/1744357.gif?1744357&103"></div></a>
		...
		<div id="box"><center>
			...
			<h4 align="center"><font color = "green">Welcome, <?php echo base64_decode($_COOKIE['sid_name']);?> (<a href = "index.php?page=logout">esci</a>)</font></h4>
			...
			<div id = "main">
				...
				<br />
				<input type="button" value="Indietro" align="left" onclick="go('home');"> |
				<input type="button" value="Avanti" align="left" onclick="go('giorno1');">
			</div>
			<div id = "giorno1">
				Seleziona i forum per il primo giorno.<br />
				<b>I forum che hai già scelto sono selezionati già ma li devi solo ri-cliccare per confermare</b>
				<br />
				<br />
				<table width = "700px">
					<tr>
						<td width="200px"><input type="radio" name="main1" value="Forum0" id = "a.0" onclick = "hide('112');hide('11');show('10');"/>Un solo turno<br /></td>
						<td width="200px"><input type="radio" name="main1" value="Forum0" id = "a.1" onclick = "show('112');show('11');hide('10');"/>Due turni<br /></td>
						<td width="300px"><input type="radio" name="main1" value="97,UmVsYXRvcmU=,1040" id = "1.97" onclick="add0(1,0,this.value); hide('112'); hide('11'); hide('10');" />Relatore<br />
							<input type="radio" name="main1" value="96,U2VjdXJpdHk=,1040" id = "1.96" onclick="add0(1,0,this.value); hide('112'); hide('11'); hide('10');" />Security<br />
							<input type="radio" name="main1" value="98,QXNzZW50ZQ==,1040" id = "1.98" onclick="add0(1,0,this.value); hide('112'); hide('11'); hide('10');" />Assenza<br />
						</td>
					</tr>
					<tr>
						<td width="200px">
			...
			<div id = "giorno2">
				...
				<table width = "700px">
					<tr>
						<td width="200px"><input type="radio" name="main1" value="Forum0" id = "b.0" onclick = "hide('212');hide('21');show('20');"/>Un solo turno<br /></td>
						<td width="200px"><input type="radio" name="main1" value="Forum0" id = "b.1" onclick = "show('212');show('21');hide('20');"/>Due turni<br /></td>
						<td width="300px"><input type="radio" name="main1" value="97,UmVsYXRvcmU=,1040" id = "2.97" onclick="add0(2,0,this.value); hide('212'); hide('21'); hide('20');" />Relatore<br />
							<input type="radio" name="main1" value="96,U2VjdXJpdHk=,1040" id = "2.96" onclick="add0(2,0,this.value); hide('212'); hide('21'); hide('20');" />Security<br />
							<input type="radio" name="main1" value="98,QXNzZW50ZQ==,1040" id = "2.98" onclick="add0(2,0,this.value); hide('212'); hide('21'); hide('20');" />Assenza<br />
						</td>
					</tr>
					<tr>
						<td width="200px">
			...
			<div id = "giorno3">
				...
				<table width = "700px">
					<tr>
						<td width="200px"><input type="radio" name="main1" value="Forum0" id = "c.0" onclick = "hide('312');hide('31');show('30');"/>Un solo turno<br /></td>
						<td width="200px"><input type="radio" name="main1" value="Forum0" id = "c.1" onclick = "show('312');show('31');hide('10');"/>Due turni<br /></td>
						<td width="300px"><input type="radio" name="main1" value="97,UmVsYXRvcmU=,1040" id = "3.97" onclick="add0(3,0,this.value); hide('312'); hide('31'); hide('30');" />Relatore<br />
							<input type="radio" name="main1" value="96,U2VjdXJpdHk=,1040" id = "3.96" onclick="add0(3,0,this.value); hide('312'); hide('31'); hide('30');" />Security<br />
							<input type="radio" name="main1" value="98,QXNzZW50ZQ==,1040" id = "3.98" onclick="add0(3,0,this.value); hide('312'); hide('31'); hide('30');" />Assenza<br />
						</td>
					</tr>
					<tr>
						<td width="200px">
			...
			<div id = "home">
				Questa è la tua lista personale<br />
				<b>Rincontrollare bene i forum perchè ci potrebbere essere degli errori</b>
				<br />
				<br />
					<table>
						<tr>
				...
				Questa pagina può essere stampata cliccando qui sotto.
				<br />
				<input type="button" value="Modifica" align="left" onclick="go('main');"> | 
				<input type="button" value="Conferma" align="left" onclick="confirm();"> | 
				<input type="button" value="Stampare" align="left" onclick="window.print();">
			</div>
			<div id = "id">
			...
			<div>
				...
				<br />
				<br />
				Ricarica la pagina per vedere se tutto è stato inserito correttamente: 
				<input type="button" value="Ricarica" onClick="window.location.reload()">
			</div>
			<br />
			<br />
			<hr width="90%" />
			...
			<script type="text/javascript">
				...
				function send(g,i){
					...
					var ok;
					var url = "index.php?page=mod&g="+g+"&m="+JSON.encode(m)+"&i="+JSON.encode(o)
				...
				function confirm(){
					var xmlhttp;
					var id = "<?php echo $_COOKIE['sid_id']; ?>";
					if (window.XMLHttpRequest){
						xmlhttp=new XMLHttpRequest();
					}else{
						xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
					...
					xmlhttp.open("GET","index.php?page=confirm&id="+id,false);
  					xmlhttp.send();
  					do{}while(ok != "ok");
				}
			</script>

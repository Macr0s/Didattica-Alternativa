...
<a href="http://www.histats.com" alt="contatore" target="_blank" ><div id="histatsC"><img border="0" src="http://s4is.histats.com/stats/i/1744357.gif?1744357&103"></div></a>
		...
		<div id="box"><center>
			...
			<h2 align="center">Accesso</h2>
			<h4 align="center"><font color="red">Username e/o Password Sbagliate</font></h4>
			
			Il momento della fine dell'iscrizione è tra: 
				<script language="JavaScript">
				TargetDate = "<?php echo $m;?>/<?php echo $g;?>/<?php echo $y;?> <?php echo $h;?>:00 PM";
				BackColor = "";
				ForeColor = "black";
				CountActive = true;
				CountStepper = -1;
				...
				FinishMessage = "Ora ti puoi iscrivere. Ricarica la pagina";
			</script>
			...
			<form name="input" action="index.php?page=login" method="post">
				...
				<input type="submit" name="login" class="logbutton" value="Entra" title="">
			</form>
			<br />
			<br />
			<hr width="90%" />

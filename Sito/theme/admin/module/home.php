...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	...
	<body>
		<div id="box"><center>
			...
			<h2 align="center"><font color="green">Benvenuto, <?php echo base64_decode($_COOKIE['sid_name']);?></font></h2>
			Le funzioni disponibili sono:
			<ul>
				<li>Modifica la tua scheda personale: <a href="index.php">Clicca qui</a></li>
				<li>Cerca le persone e i loro forum: <a href="index.php?page=admin&w=search">Clicca qui</a></li>
				<li>Visualizza le classi e i loro forum: <a href="index.php?page=admin&w=classe">Clicca qui</a></li>
				<li>Visualizza tutti i relatori <a href="index.php?page=admin&w=relatore">Clicca qui</a></li>
				<li>Visualizza tutta la security: <a href="index.php?page=admin&w=security">Clicca qui</a></li>
				<li>Visualizza tutta gli assenti gi&agrave; programmati: <a href="index.php?page=admin&w=assenti">Clicca qui</a></li>
				<li>Visualizza tutti i forum: <a href="index.php?page=admin&w=forum">Clicca qui</a></li>
				<li>Visualizza le statistiche: <a href="index.php?page=admin&w=stat">Clicca qui</a></li>
			</ul>
			<br />
